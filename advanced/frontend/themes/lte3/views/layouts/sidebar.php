        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget(
                ...
                'items' => [
                    ...
                    ['label' => 'Configurasi Printer', 'url'=>['/site/settingsave'],'icon' => 'link', 'visible' => !Yii::$app->user->isGuest],
                    ['label' => 'Connect to Printer', 'url'=>['/site/eksekusi'],'target'=>'_blank','icon' => 'print', 'visible' => !Yii::$app->user->isGuest],
                    ['label' => 'Configurasi Camera', 'url'=>['/site/settingcamera'],'icon' => 'link', 'visible' => !Yii::$app->user->isGuest],
