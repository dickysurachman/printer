...
Carton on this Pallet
  <table class="table">
    ...
    foreach($model->detail as $value){
        ...
        echo "<tr><td>".$i."</td>";
        echo "<td>".$value->carton->var_1."</td>";
        echo "<td>".$value->carton->var_2."</td>";
        echo "<td>".$value->carton->var_3."</td>";
        echo "<td>".$value->carton->var_5."</td></tr>";
       
        $i++; 
      }
        ?>
      </table>
All Item on this Pallet
  <table class="table">
            <tr>
                <th>No</th>
                <th>NIE</th>
    ...
    foreach($model->detail as $value){
        ...
        echo "<td>".(isset($val->itemd)?$val->itemd->var_2:'')."</td>";
        echo "<td>".(isset($val->itemd)?$val->itemd->var_3:'')."</td>";
        echo "<td>".(isset($val->itemd)?$val->itemd->var_5:'')."</td></tr>";
        $i++; 
        }
        }
        }
