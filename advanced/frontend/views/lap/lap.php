...
if(isset($model->tanggal)) {
  ...
  $karton=Itemkardus::find()->where(' tanggal between "'.$model->tanggal.'" and "'.$model->nama.'"')->count();
  $pallet=Itempallet::find()->where(' tanggal between "'.$model->tanggal.'" and "'.$model->nama.'"')->count();
