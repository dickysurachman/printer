...
/**
 * ItempalletSearch represents the model behind the search form about `app\models\Itempallet`.
 */
class ItempalletSearch extends Itempallet
{
    /**
     * @inheritdoc
     */
