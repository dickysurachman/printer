...
$server = new SocketServer("192.168.20.9",5001); // Create a Server binding to the given ip address and listen to port 31337 for connections
...
function handle_input(&$server,&$client,$input) {
    ...
    SocketServer::socket_write_smart($client->socket,"String? ".$trim($input),""); // Request Another String
}
